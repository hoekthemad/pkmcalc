let convertIntToCurrency = (number) => {
    ...
    if (count == number.toString().length && count >= 15) theprice = "<span class='diamond'>"+theprice;
    if (count == number.toString().length && count >= 13 && count <= 16) theprice = "<span class='topaz'>"+theprice;
    if (count == number.toString().length && count >= 11 && count <= 14) theprice = "<span class='ruby'>"+theprice;
    if (count == number.toString().length && count >= 9 && count <= 12) theprice = "<span class='amethyst'>"+theprice;
    if (count == number.toString().length && count >= 7 && count <= 10) theprice = "<span class='emerald'>"+theprice;
    if (count == number.toString().length && count >= 5 && count <= 8) theprice = "<span class='platinum'>"+theprice;
    if (count == number.toString().length && count >= 3 && count <= 6) theprice = "<span class='gold'>"+theprice;
    if (count == number.toString().length && count >= 1 && count <= 4) theprice = "<span class='silver'>"+theprice;
